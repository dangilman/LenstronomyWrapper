...
def forward_model_dynamic(x_image, y_image, magnfications, macromodel_class, source_size_pc,
                  pyhalo_dynamic, pyhalo_kwargs, realization_type, opt_routine, constrain_params,
    ...
    cosmo = pyhalo_dynamic._cosmology
    z_source = pyhalo_dynamic.zsource

    lens_system = QuadLensSystem(macromodel_class, z_source, quasar, None, cosmo)
    lens_system.initialize(data_class)

    optimizer_class = DynamicOptimization
