...
class AnalogModel(object):
    ...
    def __init__(self, lens_class_instance, kwargs_cosmology,
        ...
        if pyhalo is None:
            pyhalo = pyHalo(self.zlens, self.zsource, cosmology_kwargs=kwargs_cosmology)
        self.pyhalo = pyhalo
    ...
    def run(self, N, realization_type, realization_kwargs, arrival_time_sigma,
        ...
        return flux_anomalies, baseline, time_anomalies, time_anomalies_geo, time_anomalies_grav
    ...
    def model_setup(self, realization_type, realization_kwargs, arrival_time_sigma, realization=None):
        ...
        data_kwargs = {'psf_type': 'None', 'window_size': 2*window_size, 'deltaPix': 0.025}
    ...
    def fit_smooth(self, arc_quad_lens, data, time_delay_likelihood, fix_D_dt,
                   n_particles=50, n_iterations=150, n_run=10, walkerRatio=4):
        ...
        mcmc_kwargs = {'n_burn': 5, 'n_run': n_run, 'walkerRatio': walkerRatio, 'sigma_scale': .1}
