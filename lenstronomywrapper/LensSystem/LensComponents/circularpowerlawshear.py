...
class CircularPowerlawShear(ComponentBase):

    def __init__(self, redshift, kwargs_init=None, convention_index=False,
                 reoptimize=False, prior=[]):

        """
        This class defines an circular power law mass profile plus external shear.
        ...
        = [{'theta_E': 1, 'center_x': 0., 'center_y':, 0., 'gamma': 2.03},
        ...
        super(CircularPowerlawShear, self).__init__(self.lens_model_list, [redshift]*self.n_models,
    ...
    def param_sigma(self):
        ...
        if self.reoptimize:
            ...
            return [{'theta_E': 0.25, 'center_x': 0.1, 'center_y': 0.1, 'gamma': 0.15},
                    {'gamma1': 0.1, 'gamma2': 0.1}]

    @property
    def param_lower(self):

        lower = [{'theta_E': 0.05, 'center_x': -2., 'center_y': -2., 'gamma': 1.2},
    ...
    def param_upper(self):
        ...
        upper = [{'theta_E': 4., 'center_x': 2., 'center_y': 2., 'gamma': 2.8},
                 {'gamma1': 0.6, 'gamma2': 0.6}]
        return upper
